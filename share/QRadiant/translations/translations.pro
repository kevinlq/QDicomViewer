...
TRANSLATIONS = $$prependAll(LANGUAGES, $$PWD/QRadiant_,.ts)
...
files = $$files($$PWD/*_??.ts) $$PWD/QRadiant_untranslated.ts
for(file, files) {
...
qmfiles.files = $$prependAll(LANGUAGES, $$IDE_DATA_PATH/translations/QRadiant_,.qm)
