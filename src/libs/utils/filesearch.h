...
class QRADIANT_UTILS_EXPORT FileIterator
{
public:
    class Item
    {
...
class QRADIANT_UTILS_EXPORT FileListIterator : public FileIterator
{
public:
...
class QRADIANT_UTILS_EXPORT SubDirFileIterator : public FileIterator
{
public:
...
class QRADIANT_UTILS_EXPORT FileSearchResult
{
public:
    FileSearchResult() {}
...
QRADIANT_UTILS_EXPORT QFuture<FileSearchResultList> findInFiles(const QString &searchTerm, FileIterator *files,
    QTextDocument::FindFlags flags, const QMap<QString, QString> &fileToContentsMap = QMap<QString, QString>());

QRADIANT_UTILS_EXPORT QFuture<FileSearchResultList> findInFilesRegExp(const QString &searchTerm, FileIterator *files,
    QTextDocument::FindFlags flags, const QMap<QString, QString> &fileToContentsMap = QMap<QString, QString>());

QRADIANT_UTILS_EXPORT QString expandRegExpReplacement(const QString &replaceText, const QStringList &capturedTexts);
QRADIANT_UTILS_EXPORT QString matchCaseReplacement(const QString &originalText, const QString &replaceText);
