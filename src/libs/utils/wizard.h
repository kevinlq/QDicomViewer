...
class QRADIANT_UTILS_EXPORT Wizard : public QWizard
{
    Q_OBJECT
...
public:
    explicit Wizard(QWidget *parent = 0, Qt::WindowFlags flags = Qt::WindowType::Widget);
    ~Wizard() override;
...
class QRADIANT_UTILS_EXPORT WizardProgress : public QObject
{
    Q_OBJECT
...
class QRADIANT_UTILS_EXPORT WizardProgressItem // managed by WizardProgress
{
