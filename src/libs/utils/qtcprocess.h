...
class QRADIANT_UTILS_EXPORT QtcProcess : public QProcess
{
    Q_OBJECT
...
public:
    ...
    class QRADIANT_UTILS_EXPORT Arguments
    {
    public:
     ...
     */
    class QRADIANT_UTILS_EXPORT ArgIterator {
    public:
    ...
    class QRADIANT_UTILS_EXPORT ConstArgIterator {
    public:
