...
QRADIANT_UTILS_EXPORT QString fileNameToCppIdentifier(const QString &s);

QRADIANT_UTILS_EXPORT QString headerGuard(const QString &file);
QRADIANT_UTILS_EXPORT QString headerGuard(const QString &file, const QStringList &namespaceList);
...
QRADIANT_UTILS_EXPORT void writeBeginQtVersionCheck(QTextStream &str);

QRADIANT_UTILS_EXPORT void writeQtIncludeSection(const QStringList &qt4,
