...
namespace Utils {
class QRADIANT_UTILS_EXPORT FadingPanel : public QWidget
{
    Q_OBJECT
...
class QRADIANT_UTILS_EXPORT FadingWidget : public FadingPanel
{
    Q_OBJECT
public:
...
class QRADIANT_UTILS_EXPORT DetailsButton : public QAbstractButton
{
    Q_OBJECT
