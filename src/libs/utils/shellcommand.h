...
class QRADIANT_UTILS_EXPORT ProgressParser
{
public:
    ProgressParser();
...
class QRADIANT_UTILS_EXPORT OutputProxy : public QObject
{
    Q_OBJECT
...
class QRADIANT_UTILS_EXPORT ShellCommand : public QObject
{
    Q_OBJECT
