...
class QRADIANT_UTILS_EXPORT EnvironmentItem
{
public:
...
QRADIANT_UTILS_EXPORT QDebug operator<<(QDebug debug, const EnvironmentItem &i);

class QRADIANT_UTILS_EXPORT Environment
{
public:
