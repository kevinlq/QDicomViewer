...
QRADIANT_UTILS_EXPORT QDebug operator<<(QDebug dbg, const Utils::FileName &c);
...
class QRADIANT_UTILS_EXPORT FileName : private QString
{
public:
    FileName();
...
QRADIANT_UTILS_EXPORT QTextStream &operator<<(QTextStream &s, const FileName &fn);

using FileNameList = QList<FileName>;

class QRADIANT_UTILS_EXPORT FileUtils {
public:
...
class QRADIANT_UTILS_EXPORT FileReader
{
...
class QRADIANT_UTILS_EXPORT FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
    FileSaverBase();
...
class QRADIANT_UTILS_EXPORT FileSaver : public FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
...
class QRADIANT_UTILS_EXPORT TempFileSaver : public FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
...
QT_BEGIN_NAMESPACE
QRADIANT_UTILS_EXPORT uint qHash(const Utils::FileName &a);
QT_END_NAMESPACE
