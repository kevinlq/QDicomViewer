...
class QRADIANT_UTILS_EXPORT Theme : public QObject
{
    Q_OBJECT
...
private:
    friend QRADIANT_UTILS_EXPORT Theme *creatorTheme();
    friend QRADIANT_UTILS_EXPORT Theme *proxyTheme();
    QPair<QColor, QString> readNamedColor(const QString &color) const;
};

QRADIANT_UTILS_EXPORT Theme *creatorTheme();
QRADIANT_UTILS_EXPORT Theme *proxyTheme();
